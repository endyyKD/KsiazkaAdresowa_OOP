...
PlikZAdresatami::PlikZAdresatami(string nazwaPliku) : PlikTekstowy(nazwaPliku), NAZWA_TYMCZASOWEGO_PLIKU_Z_ADRESATAMI("Adresaci_tymczasowo.txt")
{
...
void PlikZAdresatami::dopiszAdresataDoPliku(Adresat adresat)
{
    ...
    plikTekstowy.close();
    ostatnieIdZPlikuZAdresatami = adresat.pobierzId();
...
vector<Adresat> PlikZAdresatami::wczytajAdresatowZalogowanegoUzytkownikaZPliku(int idZalogowanegoUzytkownika)
{
    ...
    if (plikTekstowy.good() == true)
    {
        ...
        {
            int id = pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(daneJednegoAdresataOddzielonePionowymiKreskami);
            if (id > ostatnieIdZPlikuZAdresatami)
                ostatnieIdZPlikuZAdresatami = id;
...
int PlikZAdresatami::pobierzOstatnieIdZPliku()
{
    return ostatnieIdZPlikuZAdresatami;
}
...
void PlikZAdresatami::usunAdresataZPliku(int idAdresata)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true && idAdresata != 0)
    {
        ...
        if (idAdresata == ostatnieIdZPlikuZAdresatami)
            ostatnieIdZPlikuZAdresatami--;
    }
}