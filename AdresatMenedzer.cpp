...
void AdresatMenedzer::wyszukajAdresatowPoImieniu()
{
    ...
    if (!adresaci.empty())
    {
        cout << ">>> WYSZUKIWANIE ADRESATOW O IMIENIU <<<" << endl
             << endl;
...
void AdresatMenedzer::wyszukajAdresatowPoNazwisku()
{
    ...
    if (!adresaci.empty())
    {
        cout << ">>> WYSZUKIWANIE ADRESATOW O NAZWISKU <<<" << endl
             << endl;
...
void AdresatMenedzer::wyswietlIloscWyszukanychAdresatow(int iloscAdresatow)
{
    if (iloscAdresatow == 0)
        cout << endl
             << "W ksiazce adresowej nie ma adresatow z tymi danymi." << endl;
    else
        cout << endl
             << "Ilosc adresatow w ksiazce adresowej wynosi: " << iloscAdresatow << endl
             << endl;
}